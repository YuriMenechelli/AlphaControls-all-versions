...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = acntBCB2007_R.bpl
OBJFILES = acntBCB2007_R.obj sVCLUtils.obj sAlphaGraph.obj \
    ...
    sDefaults.obj sDialogs.obj sEdit.obj sFade.obj sFrameAdapter.obj \
    sGauge.obj sGlyphUtils.obj sGradient.obj sGraphUtils.obj \
    sGroupBox.obj sHintManager.obj sHtmlParse.obj sLabel.obj sListView.obj \
...
RESFILES = acntBCB2007_R.res
MAINSOURCE = acntBCB2007_R.cpp
RESDEPEN = $(RESFILES) sPopupClndr.dfm
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
LIBRARIES = 
PACKAGES = rtl.bpi vcl.bpi vclx.bpi vcljpg.bpi dbrtl.bpi vcldb.bpi
SPARELIBS = rtl.lib
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
